...
/**
 * this is generated from the basisSetOrderGen.pl
 * in libint order
 */
const Int MAX_ANG_GLOBAL_BASIS_SET_INDICES = 20;

const Int GLOBAL_BASIS_SET_INDICES[ ] = {
	0,  0,  0,  /*L = 0*/
	1,  0,  0,  /*L = 1*/
	0,  1,  0,
	0,  0,  1,
 ...
 *
 */
inline void getlmn(const Int& lmin, const Int& lmax, const Int& index, 
		Int& l, Int& m, Int& n) {
	if (lmax<=MAX_ANG_GLOBAL_BASIS_SET_INDICES) {
		Int k = lmin*(lmin+1)*(lmin+2)/6 + index; // always in cartesian form
