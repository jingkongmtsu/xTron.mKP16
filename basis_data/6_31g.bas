...
#
# this file is same with the basis set data file from NWChem 6-31gs
# the only exception is that we changed the "spherical" into "cartesian"
# since all of 6-31G basis sets are Cartesian
#


basis "H_6-31G" CARTESIAN
H    S
